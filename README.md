...
## Building
As this is an Astro project, the deployment is pretty easy - you can use the Dockerfile to deploy from Coolify. In development environments, do `npm run dev`!
